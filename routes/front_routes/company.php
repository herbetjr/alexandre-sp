...
Route::get('testing', 'Company\CompanyController@weeklyPayment');
Route::get('approval-link-company/{id}', 'Company\CompanyController@approvallinkcompany')->name('payment.approvallinkcompany');
