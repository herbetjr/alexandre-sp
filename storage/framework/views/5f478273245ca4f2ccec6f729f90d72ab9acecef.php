                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="navbar-collapse collapse" id="nav-main">
                        <ul class="nav navbar-nav">
                            ...
                            <?php endif; ?>
                            <li class="dropdown userbtn"><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('/')); ?>images/lang.png"
                                                                                     alt="" class="userimg"/></a>
                                <ul class="dropdown-menu">
        ...
        <script>
            $(document).ready(function () {
                ...
                hire_channel.bind('hire-candidate-event', function (hiredCandidateNotification) {
                    ...
                    dropdown_menu.prepend('<li class="notification"><a href="<?php echo e(url('job')); ?>' + '/' + hiredCandidateNotification.jobSlug + '">' + hiredCandidateNotification.content + '</li>');
                });

                //Also remember to change channel and event name if your's are different.
                let hire_channel = pusher.subscribe('company-new-message');
                hire_channel.bind('company-new-message-event', function (newmsg) {
                    let dropdown_menu = $('#dropdown-menu');
                    dropdown_menu.prepend('<li class="notification"><a href="<?php echo e(url('newmsg.jobSlug')); ?>">' + newmsg.content + '</li>');
                });

                 //Also remember to change channel and event name if your's are different.
                let hire_channel = pusher.subscribe('candidate-new-message');
                hire_channel.bind('candidate-new-message-event', function (newmsg) {
                    let dropdown_menu = $('#dropdown-menu');
                    dropdown_menu.prepend('<li class="notification"><a href="<?php echo e(url('newmsg.jobSlug')); ?>">' + newmsg.content + '</li>');
                });
            });
    ...
    <?php else: ?>
        <script>
            ...
            channel.bind('employer-notification', function (employerNotification) {
                ...
                let dropdown_menu = $('#dropdown-menu');
                dropdown_menu.prepend('<li class="notification"><a href="<?php echo e(url('job')); ?>' + '/' + employerNotification.jobSlug + '">' + employerNotification.content + '</li>');
            });
        </script>
    <?php endif; ?>
<?php $__env->stopPush(); ?>