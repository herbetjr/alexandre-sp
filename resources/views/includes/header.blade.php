        ...
        <script>
            $(document).ready(function () {
                ...
                hire_channel.bind('hire-candidate-event', function (hiredCandidateNotification) {
                    ...
                    dropdown_menu.prepend('<li class="notification"><a href="{{ url('job') }}' + '/' + hiredCandidateNotification.jobSlug + '">' + hiredCandidateNotification.content + '</li>');
                });
                ...
                hire_channel.bind('company-new-message-event', function (newmsg) {
                    let dropdown_menu = $('#dropdown-menu');
                    dropdown_menu.prepend('<li class="notification"><a href="{{ url('newmsg.jobSlug') }}">' + newmsg.content + '</li>');
                });
    ...
    @else
        <script>
            ...
            channel.bind('employer-notification', function (employerNotification) {
                ...
                let dropdown_menu = $('#dropdown-menu');
                dropdown_menu.prepend('<li class="notification"><a href="{{ url('job') }}' + '/' + employerNotification.jobSlug + '">' + employerNotification.content + '</li>');
            });
        </script>
    @endif
@endpush