...
class SeekerSendController extends Controller
{
    ...
    public function post_company_messages(Request $request) {
        ...
        $content = Auth::user()->name." has sent you a New message";
        ...
        $newMsgNotification = [
                'jobSlug' => 'company-chats',
                'content' => $content,
                'notificationId' => $notification->id
        ];

        $pusher->trigger('candidate-new-message', 'candidate-new-message-event', $newMsgNotification);
