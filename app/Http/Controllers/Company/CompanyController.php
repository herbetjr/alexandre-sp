...
class CompanyController extends Controller
{
        ...
        if(!empty($completedMileStones->toArray())){
            foreach ($completedMileStones as $payDetails) {
                ...
                $redirect_urls = new RedirectUrls();
                        $redirect_urls->setReturnUrl(URL::route('payment.approvallinkcompany', $milestoneJobId))
    ...
    public function approvallinkcompany($jobId) {
    ...
    public function removeFromFavouriteApplicant(Request $request, $application_id, $user_id, $job_id, $company_id)
    {
        ...
        /* return \Redirect::route('applicant.profile', $application_id); */
        return \Redirect::route('list.applied.users', $job_id);
    }
